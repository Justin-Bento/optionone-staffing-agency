export default function Footer() {
  return (
    <footer>
      <section className="flex flex-col-reverse items-center justify-between w-full p-4 px-4 py-10 mx-auto space-y-6 space-y-reverse text-sm font-medium text-gray-500 md:container md:mx-auto max-w-7xl md:flex-row md:items-start md:space-y-0">
