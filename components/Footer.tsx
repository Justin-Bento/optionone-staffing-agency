        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className="text-gray-400 type-body-medium hover:text-gray-500">
          ...
          <div className="grid grid-cols-2 gap-8 mt-12 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="type-title-medium">Solutions</h3>
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-gray-600 hover:text-gray-900 type-body-medium">
                        {item.name}
                      </a>
                    </li>
                  ))}
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="type-title-medium">Support</h3>
                <ul role="list" className="mt-4 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="type-title-medium">Company</h3>
                <ul role="list" className="mt-4 space-y-4">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="type-title-medium">Legal</h3>
                <ul role="list" className="mt-4 space-y-4">
