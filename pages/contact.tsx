  ...
  return (
    <div className="bg-white">
      <main className="overflow-hidden">
        {/* Header */}
        <div className="my-16 bg-warm-gray-50">
          <div className="relative z-10 max-w-5xl pl-4 pr-8 mx-auto sm:px-6 lg:px-8">
        ...
        <section aria-labelledby="offices-heading">
          <div className="max-w-5xl px-6 py-16 mx-auto lg:px-8">
            <h2
              id="offices-heading"
